 ...
 @section('main-section')
     <section class="default-banner active-blog-slider">
         <div class="item-slider relative" style="background: url('{{ url('frontend/img/slider1.jpg') }}') center/cover;">
         ...
         <div class="item-slider relative" style="background: url('{{ url('frontend/img/slider2.jpg') }}') center/cover;">
         ...
         <div class="item-slider relative" style="background: url('{{ url('frontend/img/slider3.jpg') }}') center/cover;">
                     ...
                     <div class="item">
                         ...
                         <div class="caption text-center mt-20">
                             ...
                             <p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have
                                 <br> allowed humanity to create slimmer, more portable technology.
                             </p>
                         </div>
                     </div>
                     <div class="item">
         ...
         <div class="container">
             ...
             <div class="video-content">
                 <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img
                         src="{{ url('frontend/img/play-btn.png') }}" alt=""></a>
